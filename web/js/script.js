...
$(function(){
  var token = "524cbb74b755c348dba3f88400a99d9a2816d8ae";
  ...
  var commitsByDay = {},
      ...
      bucketCommits = function(page, cb) {
        ...
        $.getJSON('https://api.github.com/repos/topscore/topscore/commits' , {access_token: token, sha: 'master', page: page, per_page: 100}, function(data) {
